...
<div class="p-2.5 md:p-6 text-[13px] lg:text-base">
    <form action="#" class="bg-white rounded-xl p-5 block" id="invoice_form">

        @csrf
      <div class="flex flex-wrap items-end gap-4">
        <div class="">
          <div class="flex items-center flex-wrap gap-3 max-w-[100%]">
            <div class="flex-1">
              <label
                for="bill"
      ...
      <div class="">
        ...
        <div class="flex gap-3 flex-wrap items-end overflow-x-auto pb-3">
          <div class="flex-grow flex-shrink-0 main-table  table-wrapper ">
            <table
...
<script>
    ...
    <script>
        ...
        document.getElementById("rDics").addEventListener("keydown", function(event) {
