        ...
        <div class="flex items-center flex-wrap gap-3 max-w-[350px]">
          <div class="flex-1">
            ...
            <input
              id="date"
              type="date"
              class="no-arrows w-full border border-gray-300 flex-1 transition-all ease-in-out duration-200 focus:border-none focus:outline-indigo-500 px-4 py-1 rounded-md"
            />
          </div>
        ...
        >
          ...
          <div class="w-full max-w-[350px]">
            ...
            <select
              name="p-name"
              id="p-name"
              class="border border-gray-300 transition-all w-full ease-in-out duration-200 focus:outline-indigo-500 px-4 py-1 rounded-md"
            >
