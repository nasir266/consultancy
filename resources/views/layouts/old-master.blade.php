...
<html lang="en" class="h-full bg-gray-100">
  ...
  <body class="h-full">
    <div class="min-h-screen bg-gray-100">
      ...
      >
        ...
        <div class="flex items-center gap-5">
          ...
          <button
            class="w-8 h-8 lg:h-10 lg:w-10 rounded-full bg-gray-200 flex items-center justify-center"
          >
            <i
              data-feather="user"
              class="w-4 h-4 lg:w-6 lg:h-6 text-gray-500"
            ></i>
          </button>
        </div>
      </div>
          ...
          <div class="group relative hover:bg-gray-100 cursor-pointer">
            ...
            >
              ...
              <ul class="text-[13px] pl-6 pb-6 space-y-3">
                ...
                >
                  <a href="../" class="flex-1 block">Add New Party</a>
                ...
                <li class="relative group/area">
                  ...
                  >
                    ...
                    >
                      <a href="../city/" class="flex-1 block">City</a>
                    ...
                    <li
                      class="flex items-center justify-between gap-2 hover:text-indigo-600"
                    >
                      <a href="../area-menu/" class="flex-1 block">Area Menu</a>
                ...
                >
                  <a href="../add-item/" class="flex-1 block">Add Item</a>
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../add-new-sales-man/" class="flex-1 block"
                    >Add New Sales Man</a
                  >
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../add-retail-sale-rate/" class="flex-1 block"
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../add-new-goddown/" class="flex-1 block"
                    >Add New Godown</a
                  >
                  <button data-label="Add New Goddown" type="button">
                    <i class="fa-solid fa-star text-gray-300 text-xs"></i>
                  </button>
                </li>
              </ul>
            ...
            >
              ...
              <ul class="text-[13px] pl-6 pb-6 space-y-3">
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../sale-invoice/" class="flex-1 block"
                    >Sale Invoice</a
                  >
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../purchase-invoice/" class="flex-1 block"
                    >Purchase Invoice</a
                  >
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../purchase-return-invoice/" class="flex-1 block"
            ...
            >
              ...
              <ul class="text-[13px] pl-6 pb-6 space-y-3">
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../customer-payment-received/" class="flex-1 block"
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../customer-cheque-post/" class="flex-1 block"
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../party-payment/" class="flex-1 block"
                    >Party Payment</a
                  >
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../party-cheque-post/" class="flex-1 block"
                    >Party Cheque Post</a
                  >
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../stock-navigation-voucher/" class="flex-1 block"
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../stock-adjustment-voucher/" class="flex-1 block"
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../journal-voucher/" class="flex-1 block"
                    >Journal Voucher</a
                  >
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../search-all-vouchers/" class="flex-1 block"
            ...
            >
              ...
              <ul class="text-[13px] pl-6 pb-6 space-y-3">
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../barcode-setting/" class="flex-1 block"
                    >Barcode Setting</a
                  >
                ...
                <li
                  class="flex items-center justify-between gap-2 pr-2 hover:text-indigo-600"
                >
                  <a href="../greeting/" class="flex-1 block">Greeting</a>
      ...
      <div class="lg:pl-64">
        <div
          class="bg-white flex items-center flex-wrap gap-4 px-6 py-4 md:py-0 md:h-16 justify-between shadow-sm"
        >
    ...
    <script src="{{asset('assets/js/trackpath.js?v=2')}}"></script>
    <script src="{{asset('assets/js/favouritesPath.js?v=2')}}"></script>
  ...
  ></script>
    ...
    <script>
      ...
      toastr.options = {
        ...
        "timeOut": "5000", // Notification timeout (adjust as needed)
        "extendedTimeOut": "1000", // Extra time if hovered (optional)
        "closeButton": true, // Show close button
        "progressBar": true, // Show progress bar (optional)
        "showDuration": "300", // Animation duration
        "hideDuration": "1000", // Fade-out duration
